...
5. (17GB) Download and unzip `no_ortho.zip`_ (md5sum: c9b226f864d5199ecd96d058081fe2eb) into the PIDGINv4 main directory (leave all subsequent files compressed)
